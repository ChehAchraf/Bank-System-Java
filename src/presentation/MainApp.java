...
public class MainApp {
    ...
    public static void main(String[] args) {
        ...
        while (choice != 2) {
            ...
            if (userAccount == null) {
                ...
                System.out.println("4 - List all your accounts ");
                System.out.println("5 - sort the account ");
                ...
                case 2:
                    try {
                        ...
                        if (epargneAccount != null) {
                            System.out.println(GREEN + "The account has beent created successfully" + RESET);
    ...
    public static void RetraitAccountMenu() {

        if (userAccount != null) {
            try {
                double mountantToGet;
                Scanner sc = new Scanner(System.in);
                System.out.println("Enter the ammount you wanna get : ");
                mountantToGet = sc.nextDouble();
                userAccount.retirer(mountantToGet);
            } catch (IllegalArgumentException e) {
